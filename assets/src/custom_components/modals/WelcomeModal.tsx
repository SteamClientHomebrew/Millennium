import { callable, DialogBody, DialogBodyText, DialogButton, DialogFooter, DialogHeader, Millennium, pluginSelf, showModal, ShowModalResult } from "@steambrew/client"
...
export const ShowWelcomeModal = async () => new Promise(async (resolve) => {
    ...
    const RenderWelcomeModal = () => (
        <GenericConfirmDialog>
            ...
            <DialogBody>
                <DialogBodyText>
                    <p>
                        We're excited for you to be apart of the community!
                        Since this is your first time launching, it’s the perfect opportunity to introduce you to a few things.
                    </p>
                    <Separator />

                    <p>
                        If you’re not familiar yet, most of Millennium's settings can be accessed <b><a href="#" style={{ color: "#d04dd0" }} onClick={OpenMillenniumSettings}>here</a></b>.
                        You can also find them under <b><a href="#" style={{ color: "#d04dd0" }} onClick={HighlightMillenniumSettings}>Steam → Millennium Settings</a></b>.
                    </p>
                    <p>
                        From there, you'll find directions on where to install themes/plugins, how to enable/disable certain features, and more.
                        <br />
                        And remember, you can always <b><a href="#" style={{ color: "#d04dd0" }} onClick={OpenDocumentation}>view our documentation</a></b> if you have any questions.
                    </p>
                ...
                <DialogFooter>
                    <div className="DialogTwoColLayout _DialogColLayout Panel">
                        <DialogButton className='Secondary' onClick={() => {
    ...
    welcomeModalWindow = showModal(
        <RenderWelcomeModal />,
        pluginSelf.mainWindow,
        {
            strTitle: "Welcome to Millennium!",
            popupHeight: 475, popupWidth: 625,
        }
    )
})
