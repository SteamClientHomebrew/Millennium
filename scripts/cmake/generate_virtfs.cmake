...
if(CMAKE_BUILD_TYPE STREQUAL "Release")
    ...
    if(DISTRO_NIX)
        ...
        set(HEADER_CONTENT "${HEADER_CONTENT}INCTXT(MILLENNIUM_FRONTEND_BIN_, \"${MILLENNIUM_BASE}/src/typescript/.frontend.bin\");\n")
    endif()
    set(HEADER_CONTENT "${HEADER_CONTENT}#endif\n\n")
    ...
    if(DISTRO_NIX)
        ...
        set(HEADER_CONTENT "${HEADER_CONTENT}INCTXT(MILLENNIUM_API_BIN_, \"${MILLENNIUM_BASE}/src/typescript/sdk/packages/loader/build/millennium.js\");\n")
    endif()
    set(HEADER_CONTENT "${HEADER_CONTENT}#endif\n\n")
...
if(CMAKE_BUILD_TYPE STREQUAL "Release" OR DISTRO_NIX)
    ...
    set(HEADER_CONTENT "${HEADER_CONTENT}\t{ fmt::format(\"https://millennium.ftp/{}/millennium-frontend.js\", GetScrambledApiPathToken()), []() { return platform::read_file(MILLENNIUM_ROOT \"/src/typescript/.frontend.bin\"); } },\n")
    set(HEADER_CONTENT "${HEADER_CONTENT}\t{ fmt::format(\"https://millennium.ftp/{}/millennium.js\", GetScrambledApiPathToken()), []() { return platform::read_file(MILLENNIUM_ROOT \"/src/typescript/sdk/packages/loader/build/millennium.js\"); } },\n")
endif()
