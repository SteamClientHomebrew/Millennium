...
file(GLOB CHUNK_FILES "${MILLENNIUM_BASE}/sdk/packages/loader/build/chunks/*")
...
if(CMAKE_BUILD_TYPE STREQUAL "Release")
    ...
    set(HEADER_CONTENT "${HEADER_CONTENT}#else\n")
    set(HEADER_CONTENT "${HEADER_CONTENT}INCTXT(MILLENNIUM_API_BIN_, \"${MILLENNIUM_BASE}/sdk/packages/loader/build/millennium.js\");\n")
    set(HEADER_CONTENT "${HEADER_CONTENT}#endif\n\n")
    ...
    set(RC_CONTENT "${RC_CONTENT}MILLENNIUM_API_BIN RCDATA \"${MILLENNIUM_BASE}/sdk/packages/loader/build/millennium.js\"\n\n")
endif()
...
if(CMAKE_BUILD_TYPE STREQUAL "Release")
    ...
    set(HEADER_CONTENT "${HEADER_CONTENT}\t{ fmt::format(\"https://millennium.ftp/{}/millennium.js\", GetScrambledApiPathToken()), []() { return SystemIO::ReadFileSync(MILLENNIUM_ROOT \"/sdk/packages/loader/build/millennium.js\"); } },\n")
endif()
